        ...
        return(
            <div className="Container">
                ...
                <div className="Job-Info">
                    ...
                    <p>This Android app let users rate their favorite Starbucks coffees.  It was coded using Android Studio, and the ratings and drinks were stored in Google FireBase.
                    </p>
                    ...
                    <p>This project had similar functions to an ATM or bank; it allowed the users to create different accounts-either checking or savings.
                        The accounts were created using Java inheritence and stored in the Derby Client Database.
                    </p>
                    <h6><strong><u>Employee payment software</u></strong></h6>
                    <p>This project allowed the user to create new employee profiles and make them either hourly or salary based.
                ...
                <div className="Job-Info">
                    ...
                    <p>I help provide a wide variety of IT support to a broad selection of clients.  Whether it is in the offices of accounting firms or out on the links of a golf course, I am troubleshooting/installing
                    ...
                    <p>
                        ...
                        As a referee, my duties include reviewing and mentoring new referees, defusing conflict with players, coaches, and fans, and managing volatile situations efficiently and diplomatically.
                    </p>
                </div>
                ...
                <div className="Edu-Info">
                    ...
                    <h6><strong><u>Bachelor of Science in Information Systems</u></strong></h6>
